class AssetResource {
  ...
  static const String accountCallUsImagePath =
      "${imagePath}account/ic_call.svg";
  static const String accountNextImagePath = "${imagePath}account/ic_next.svg";
  static const String accountAddressesImagePath =
      "${imagePath}account/ic_address.svg";
  static const String accountFacebookImagePath =
      "${imagePath}account/ic_facebook.svg";
  static const String accountTwitterImagePath =
